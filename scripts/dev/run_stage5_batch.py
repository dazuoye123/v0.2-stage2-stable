...
from alumina_sol_extractor.dataset_fusion.loaders import load_paper_inputs, read_jsonl
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Stage 5 fusion/link-aware export in batch mode.")
