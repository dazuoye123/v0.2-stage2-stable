    ...
    for record in extractions:
        ...
        payload.append(
            ...
            | {
                ...
                "al_species": record.get("al_species") or [],
                ...
                "species_summary": record.get("species_summary"),
                "possible_species": record.get("possible_species") or [],
                "reference_ticks_visible": record.get("reference_ticks_visible"),
                "visible_peak_count_estimate": record.get("visible_peak_count_estimate"),
                "thermal_events": record.get("thermal_events") or [],
                "total_mass_loss_percent": record.get("total_mass_loss_percent"),
                "final_residue_percent": record.get("final_residue_percent"),
                ...
                "morphology_type": record.get("morphology_type"),
                "surface_smoothness": record.get("surface_smoothness"),
                "compactness": record.get("compactness"),
                "fracture_type": record.get("fracture_type"),
                "diameter_estimate": record.get("diameter_estimate"),
                "diameter_unit": record.get("diameter_unit"),
                "diameter_range": record.get("diameter_range"),
                "diameter_basis": record.get("diameter_basis"),
                "particle_size_estimate": record.get("particle_size_estimate"),
                "particle_size_range": record.get("particle_size_range"),
                "particle_size_unit": record.get("particle_size_unit"),
                "particle_size_basis": record.get("particle_size_basis"),
                "morphology_features": record.get("morphology_features") or [],
                "image_quality_notes": record.get("image_quality_notes") or [],
                "likely_figure_type": record.get("likely_figure_type"),
                "safe_observations": record.get("safe_observations") or [],
                "why_uncertain": record.get("why_uncertain"),
            }
        )
    return payload
