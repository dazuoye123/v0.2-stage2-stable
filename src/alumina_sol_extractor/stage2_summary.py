...
def save_stage2_outputs(
    ...
    summary = {
        ...
        "raw_caption_count": sum(1 for figure in figures if figure.raw_caption),
        ...
        "mineru_layout_caption_count": sum(1 for figure in figures if figure.caption_source == "mineru_layout_caption"),
