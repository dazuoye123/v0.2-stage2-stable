...
def build_stage3_validation_report(
    *,
    ...
    duplicate_evidence_ids: list[dict[str, Any]],
    evidence_ref_warnings: list[dict[str, Any]],
    evidence_figure_id_mismatches: list[dict[str, Any]],
    core_parameter_without_evidence: list[dict[str, Any]],
    ...
    sections = [
        ...
        f"- duplicate_evidence_id_count: `{len(duplicate_evidence_ids)}`",
        f"- evidence_ref_warning_count: `{len(evidence_ref_warnings)}`",
        f"- evidence_figure_id_mismatch_count: `{len(evidence_figure_id_mismatches)}`",
        f"- core_parameter_without_evidence_count: `{len(core_parameter_without_evidence)}`",
        ...
        _format_issue_section("Duplicate Evidence IDs", duplicate_evidence_ids),
        _format_issue_section("Evidence Ref Warnings", evidence_ref_warnings),
        _format_issue_section("Evidence Figure ID Mismatches", evidence_figure_id_mismatches),
        _format_issue_section("Core Parameters Without Evidence", core_parameter_without_evidence),
